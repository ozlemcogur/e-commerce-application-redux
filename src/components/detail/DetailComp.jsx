    ...
    return (
        <div className='flex gap-10 my-10'>
            ...
            <div className=''>
                ...
                <div onClick={addBasket} className='my-4 border w-[200px] h-16 flex items-center justify-center text-2xl rounded-md bg-gray-200 cursor-pointer'>Sepete Ekle</div>
            </div>
        </div>
    )
}
